...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>ನ್ಯೂಸ್ ಪೋರ್ಟಲ್ | ನಮ್ಮ ಪುಟವನ್ನು ಸಂಪರ್ಕಿಸಿ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">ನಮ್ಮ ಪುಟವನ್ನು ಸಂಪರ್ಕಿಸಿ  </h4>
...
<label for="exampleInputEmail1">ಪುಟ ಶೀರ್ಷಿಕೆ</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>ಪುಟ ವಿವರಗಳು</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">ನವೀಕರಿಸಿ ಮತ್ತು ಪೋಸ್ಟ್ ಮಾಡಿ</button>
