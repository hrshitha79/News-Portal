...
<html lang="en">
    <head>
        ...
        <title> ಸುದ್ದಿ ಪೋರ್ಟಲ್ | ಅನುಮೋದಿತ ಪ್ರತಿಕ್ರಿಯೆ ಯನ್ನು ನಿರ್ವಹಿಸಿ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">ಅನುಮೋದಿತ ಪ್ರತಿಕ್ರಿಯೆಗಳನ್ನು ನಿರ್ವಹಿಸಿ</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">ಅಡ್ಮಿನ್</a>
                                        </li>
                                        <li>
                                            <a href="#">ಪ್ರತಿಕ್ರಿಯೆಗಳು </a>
                                        </li>
                                        <li class="active">
											ಪ್ರತಿಕ್ರಿಯೆಗಳನ್ನು ಅನುಮೋದಿಸುವುದಿಲ್ಲ
                                        </li>
                                    </ol>
