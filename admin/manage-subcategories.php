...
<html lang="en">
    <head>
        ...
        <title> ಸುದ್ದಿ ಪೋರ್ಟಲ್ | ಉಪವರ್ಗಗಳನ್ನು ನಿರ್ವಹಿಸಿ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">ಉಪವರ್ಗಗಳನ್ನು ನಿರ್ವಹಿಸಿ</h4>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">ಸೇರಿಸು <i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>
                                                    ...
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>ಪೋಸ್ಟ್ ಮಾಡುವ ದಿನಾಂಕ</th>
                                                                  <th>ಕೊನೆಯ ಅಪ್ಡೇಶನ್ ದಿನಾಂಕ</th>
                                                                <th>ಕ್ರಿಯೆ</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
...
<td colspan="7" align="center"><h3 style="color:red">ಯಾವುದೇ ದಾಖಲೆ ಕಂಡುಬಂದಿಲ್ಲ</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> ಅಳಿಸಿದ ಉಪವರ್ಗಗಳು</h4>
