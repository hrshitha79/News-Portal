...
<html lang="en">
    <head>
        ...
        <title>ಸುದ್ದಿ ಪೋರ್ಟಲ್ | ಉಪವರ್ಗ ಸೇರಿಸು</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">ಉಪವರ್ಗ ಸೇರಿಸು</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>ಉಪವರ್ಗ ಸೇರಿಸು </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
                                                    <label class="col-md-2 control-label">ಉಪವರ್ಗ </label>
                                                    <div class="col-md-10">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">ಉಪ-ವರ್ಗದ ವಿವರಣೆ</label>
	                                                <div class="col-md-10">
