...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>ನ್ಯೂಸ್ ಪೋರ್ಟಲ್ | ಅಳಿಸಿದ ಪೋಸ್ಟ್ ಗಳು</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">ಅಳಿಸಿದ ಪೋಸ್ಟ್ ಗಳು </h4>
...
<td colspan="4" align="center"><h3 style="color:red">ಯಾವುದೇ ದಾಖಲೆ ಕಂಡುಬಂದಿಲ್</h3></td>
<tr>
<?php 
} else {
