...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>ನ್ಯೂಸ್ ಪೋರ್ಟಲ್ | ಪೋಸ್ಟ್ ಗಳನ್ನು ನಿರ್ವಹಿಸಿ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">ಪೋಸ್ಟ್ ಗಳನ್ನು ನಿರ್ವಹಿಸಿ </h4>
...
<td colspan="4" align="center"><h3 style="color:red">ಯಾವುದೇ ದಾಖಲೆ ಕಂಡುಬಂದಿಲ್ಲ</h3></td>
<tr>
<?php 
} else {
